            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <?php if ($employe->isAutoriser("ventes")) { ?>
                    ...
                    <li class="" id="boutiques">
                        <a href="<?= $this->url($this->section, "production", "boutiques", Home\AGENCE::PRINCIPAL) ?>"><i class="fa fa-home"></i> <span class="nav-label">Les boutiques</span></a>
                    </li>
                    <li class="" id="entrepots">
                        <a href="<?= $this->url($this->section, "production", "entrepots", Home\AGENCE::PRINCIPAL) ?>"><i class="fa fa-home"></i> <span class="nav-label">Les Entrepôts</span></a>
                    </li>
